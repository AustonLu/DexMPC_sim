...
/// Filename: tphn12ffcllgv18e.v
/// Technology: CLN12FCLL001
/// Product Type: Standard I/O
/// Product Name: tphn12ffcllgv18e
/// Version: 140a
////////////////////////////////////////////////////////////////////////////////////////////
////
///  STATEMENT OF USE
...
pmos   (IRTE, I, RTECTRL);
tphn12ffcllgv18e_primitive_retention Iretention (IRTE1, RTECTRL, Idelay);
nmos   (IRTE, IRTE1, RTECTRL);

pmos   #1(OENdelay, OEN, 1'b0);
pmos   (OENRTE, OEN, RTECTRL);
tphn12ffcllgv18e_primitive_retention OENretention (OENRTE1, RTECTRL, OENdelay);
nmos   (OENRTE, OENRTE1, RTECTRL);

pmos   #1(DS0delay, DS0, 1'b0);
pmos   (DS0RTE, DS0, RTECTRL);
tphn12ffcllgv18e_primitive_retention DS0retention (DS0RTE1, RTECTRL, DS0delay);
nmos   (DS0RTE, DS0RTE1, RTECTRL);

pmos   #1(DS1delay, DS1, 1'b0);
pmos   (DS1RTE, DS1, RTECTRL);
tphn12ffcllgv18e_primitive_retention DS1retention (DS1RTE1, RTECTRL, DS1delay);
nmos   (DS1RTE, DS1RTE1, RTECTRL);

pmos   #1(DS2delay, DS2, 1'b0);
pmos   (DS2RTE, DS2, RTECTRL);
tphn12ffcllgv18e_primitive_retention DS2retention (DS2RTE1, RTECTRL, DS2delay);
nmos   (DS2RTE, DS2RTE1, RTECTRL);

pmos   #1(DS3delay, DS3, 1'b0);
pmos   (DS3RTE, DS3, RTECTRL);
tphn12ffcllgv18e_primitive_retention DS3retention (DS3RTE1, RTECTRL, DS3delay);
nmos   (DS3RTE, DS3RTE1, RTECTRL);

pmos   #1(STdelay, ST, 1'b0);
pmos   (STRTE, ST, RTECTRL);
tphn12ffcllgv18e_primitive_retention STretention (STRTE1, RTECTRL, STdelay);
nmos   (STRTE, STRTE1, RTECTRL);

pmos   #1(IEdelay, IE, 1'b0);
pmos   (IERTE, IE, RTECTRL);
tphn12ffcllgv18e_primitive_retention IEretention (IERTE1, RTECTRL, IEdelay);
nmos   (IERTE, IERTE1, RTECTRL);

pmos   #1(PEdelay, PE, 1'b0);
pmos   (PERTE, PE, RTECTRL);
tphn12ffcllgv18e_primitive_retention PEretention (PERTE1, RTECTRL, PEdelay);
nmos   (PERTE, PERTE1, RTECTRL);

pmos   #1(PSdelay, PS, 1'b0);
pmos   (PSRTE, PS, RTECTRL);
tphn12ffcllgv18e_primitive_retention PSretention (PSRTE1, RTECTRL, PSdelay);
...
tphn12ffcllgv18e_primitive_retention PUretention (PURTE1, RTECTRL, PUdelay);
nmos   (PURTE, PURTE1, RTECTRL);

pmos   #1(PDdelay, PD, 1'b0);
pmos   (PDRTE, PD, RTECTRL);
tphn12ffcllgv18e_primitive_retention PDretention (PDRTE1, RTECTRL, PDdelay);
nmos   (PDRTE, PDRTE1, RTECTRL);

bufif0 (PAD_q, IRTE, OENRTE);
pmos   (PG_PAD_1, PAD_q, 1'b0);

and    (SPU_pre_1, PURTE, PDRTE);
nmos   (SPU, SPU_pre_1, RTE);
pmos   (SPU_pre_2, SPU_pre_1, RTE);
not    (DS2B, DS2RTE);
not    (DS3B, DS3RTE);
not    (OE, OENRTE);
and    (no_pull_pre, DS2B, DS3B, OE);
pmos   (no_pull, no_pull_pre, RTE);
pmos   (SPU_1, SPU_pre_2, no_pull);
nmos   (SPU_1, 1'b0, no_pull);
pmos   (SPU, SPU_1, RTE);
...
`celldefine
module PFILLER00001 (RTE);
  input RTE;
endmodule
`endcelldefine

`celldefine
module PFILLER00001A ();
endmodule
`endcelldefine

`celldefine
module PFILLER00048 (RTE);
  input RTE;
endmodule
`endcelldefine

`celldefine
module PFILLER00048A ();
endmodule
`endcelldefine

`celldefine
module PFILLER01008 (RTE);
  input RTE;
endmodule
`endcelldefine

`celldefine
module PFILLER01008A ();
endmodule
`endcelldefine

`celldefine
module PFILLER10080 (RTE);
  input RTE;
endmodule
`endcelldefine

`celldefine
module PFILLER10080A ();
endmodule
`endcelldefine

`celldefine
module PFILLERSTRAP_H (RTE);
  input RTE;
endmodule
`endcelldefine

`celldefine
module PFILLERSTRAP_V (RTE);
  input RTE;
endmodule
`endcelldefine

`celldefine
module PFILLERSTRAPA_H ();
endmodule
`endcelldefine

`celldefine
module PFILLERSTRAPA_V ();
endmodule
`endcelldefine
...
tphn12ffcllgv18e_primitive_retention SLretention (SLRTE1, RTECTRL, SLdelay);
...
tphn12ffcllgv18e_primitive_retention SPUretention (SPURTE1, RTECTRL, SPUdelay);
...
`celldefine
module PVDD1CDGM_H (RTE);
  input RTE;
endmodule
`endcelldefine

`celldefine
module PVDD1CDGM_V (RTE);
  input RTE;
endmodule
`endcelldefine

`celldefine
module PVDD2CDGM_H (RTE);
  input RTE;
endmodule
`endcelldefine

`celldefine
module PVDD2CDGM_V (RTE);
  input RTE;
endmodule
`endcelldefine

`celldefine
module PVDD2POCM_H (RTE);
  input RTE;
endmodule
`endcelldefine

`celldefine
module PVDD2POCM_V (RTE);
  input RTE;
endmodule
`endcelldefine
...
primitive tphn12ffcllgv18e_primitive_retention (q, RTECTRL, current_state);
  output q; reg q;
