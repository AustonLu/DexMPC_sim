...
//------------------------------------------------------------------------------
// Purpose : This is the AHB-Lite Monitor Interface
//------------------------------------------------------------------------------


//============================================================================
//
// Usage: Instantiate ahb_monitor at the same level as your AHB Master/Slave. The 
...
// =====
  ...
  ahb_recm_lock_idle
    (
     .clk ( HCLK ),
     .reset_n (HRESETn),
     .antecedent_expr ( ahbpc_granted_D1 & ahbpc_granted &
                        HMASTLOCK_D1 & ~HMASTLOCK ),
     .consequent_expr ( HTRANS == `AHB_TRANS_IDLE )
     );
