...
// -----------------------------------------------------------------------------
  ...
  parameter INSTANCE_TYPE    = "AXI4M_";
...
// -----------------------------------------------------------------------------
  ...
  wire  [7:0]              ARLEN_i;         // Read burst length
  ...
  wire                     ARLOCK_i;        // Read Lock signals
  ...
  wire  [7:0]              AWLEN_i;         // Write burst length
  ...
  wire                     AWLOCK_i;        // Write Lock signals
 ...
 `ifndef SN
  ...
  wire  arvalid_match_vnet_0;
  wire  arvalid_match_vnet_1;
  wire  arvalid_match_vnet_2;
  wire  arvalid_match_vnet_3;
  wire  awvalid_match_vnet_0;
  wire  awvalid_match_vnet_1;
  wire  awvalid_match_vnet_2;
  wire  awvalid_match_vnet_3;
  wire  wvalid_match_vnet_0;
  wire  wvalid_match_vnet_1;
  wire  wvalid_match_vnet_2;
  wire  wvalid_match_vnet_3;
...
//------------------------------------------------------------------------------
  ...
  assign ARLEN    = (DriveOnlyOnEnable & ~ACLKEN) ? {8{1'bx}} : ARLEN_i;
  ...
  assign ARLOCK   = (DriveOnlyOnEnable & ~ACLKEN) ? 1'bx      : ARLOCK_i;
  ...
  assign AWLEN    = (DriveOnlyOnEnable & ~ACLKEN) ? {8{1'bx}} : AWLEN_i;
  ...
  assign AWLOCK   = (DriveOnlyOnEnable & ~ACLKEN) ? 1'bx      : AWLOCK_i;
...
// -----------------------------------------------------------------------------
  ...
  defparam uVnIDMonitor.NO_ERROR_ON_M_VNET = 1;            
  defparam uVnIDMonitor.MAXWBURSTS   = 200;
  defparam uVnIDMonitor.MAXRBURSTS   = 200;              
  defparam uVnIDMonitor.AXI4_N_3     = 1;              
  ...
  //Create registered versions of the Qos registers
  always @(posedge ACLK or negedge ARESETn)
    begin
       if (~ARESETn) begin
           AWQV_reg  <= 4'b0000;
  ...
  assign VAWQOS_0   = (AWVALID) ? AWQV_i : AWQV_reg;
  assign VARQOS_0   = (ARVALID) ? ARQV_i : ARQV_reg;
  assign VAWQOS_1   = (AWVALID) ? AWQV_i : AWQV_reg;
  assign VARQOS_1   = (ARVALID) ? ARQV_i : ARQV_reg;
  assign VAWQOS_2   = (AWVALID) ? AWQV_i : AWQV_reg;
  assign VARQOS_2   = (ARVALID) ? ARQV_i : ARQV_reg;
  assign VAWQOS_3   = (AWVALID) ? AWQV_i : AWQV_reg;
  assign VARQOS_3   = (ARVALID) ? ARQV_i : ARQV_reg;
