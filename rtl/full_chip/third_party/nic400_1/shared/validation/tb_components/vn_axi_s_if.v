...
//
// Description : This block is an AXI slave that can be used in the main NIC400
//               testbench.
//
//               Currently contain an eXVC AXIS or FRS component
//
//               NIC400r0p0 uses AWQV, ARQV and multi-bit AW and ARValid. These are
...
//------------------------------------------------------------------------------
  ...
  defparam uAxiSlaveAPB.AWUSER_WIDTH = AWUSER_WIDTH_I + 16;
  defparam uAxiSlaveAPB.WUSER_WIDTH  = WUSER_WIDTH_I;
  defparam uAxiSlaveAPB.BUSER_WIDTH  = BUSER_WIDTH_I;
  defparam uAxiSlaveAPB.ARUSER_WIDTH = ARUSER_WIDTH_I + 16;
