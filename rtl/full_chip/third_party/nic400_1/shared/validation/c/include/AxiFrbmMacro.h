...
#ifndef AXI_FRBM_MACRO_H
#define AXI_FRBM_MACRO_H
...
#define PAGE_SIZE 4096
  ...
  class AxiFrbmMacro : public FrbmMacro
  {
    public: 
    ...
    void P(transaction * trans);

    //===========
    // AW
    //===========

    void AW(transaction * trans);

    //===========
    // W
    //===========
              
    void W(transaction * trans, arm_uint8 beat);

    //===========
    // B
    //===========

    void B(transaction * trans);

    //===========
    // AR
    //===========

    void AR(transaction * trans);

    //===========
    // R
    //===========

    void R(transaction * trans, arm_uint8 beat);
