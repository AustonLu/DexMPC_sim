...
module nic400_bm0_ml_mlayer_0_1
  (
    // MasterInterface 
...
nic400_bm0_add_sel_ml0_1 u_nic400_bm0_add_sel_ml0_1 (
        // AW MasterInterface 
        .awid_m         (awid_m),
        .awaddr_m       (awaddr_m),
        .awlen_m        (awlen_m),
...
nic400_bm0_wr_sel_ml0_1 u_nic400_bm0_wr_sel_ml0_1 (
...
nic400_bm0_ret_sel_ml0_1 u_nic400_bm0_ret_sel_ml0_1 (
        // bchannel mask 
        .wr_cnt_empty (wr_cnt_empty),
 ...
 wire [2:0] rsel;
 wire [2:0] bsel;
 assign rsel = u_nic400_bm0_ret_sel_ml0_1.rsel;
 assign bsel = u_nic400_bm0_ret_sel_ml0_1.rsel;
